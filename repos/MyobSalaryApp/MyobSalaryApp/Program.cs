...
namespace MyobSalaryApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Kindly enter the input file type:");
            var fileTypeIn = Console.ReadLine();
            ...
            if (string.Equals(fileTypeIn, "csv", StringComparison.OrdinalIgnoreCase))
            {
                try
                {
            ...
            Console.WriteLine("Kindly enter the output file type:");
            var fileTypeOut = Console.ReadLine();

            if (string.Equals(fileTypeOut, "csv", StringComparison.OrdinalIgnoreCase))
